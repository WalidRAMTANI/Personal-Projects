...
def matrice(taille, nombre_image):
    # une fonction qui retoune une matrice remplie de nombre aléatoirement
...
def fonction_click_meme_image(liste):
    """
    une fonction qui determine si on a cliqué sur la meme image pour supprimer les rectangles qui entourent l'image
    """
...
def parcourir_une_ligne(liste, j, indice1, indice2, matrice1):
    # une fonction qui parcours une ligne et qui renvoi true si la ligne est vide et false si c'est l'inverse
    if indice1 > indice2:
        c = 0
...
def fonction_liste( matrice1, indice1, indice2):
    """
    cette fonction verifie ci il y'a des cases vides au dessus et en dessous de l'image et return la liste des cases 
    """
...
def page_information(largeur_fenetre, hauteur_fenetre):
    ...
    while True:
        ...
        texte7 = "Enfin pour selection une image il faut cliquer sur clique droit."
...
#generer_fenetre_jeu(largeur_fenetre, hauteur_fenetre)
